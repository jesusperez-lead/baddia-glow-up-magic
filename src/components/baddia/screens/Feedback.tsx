...
export function Feedback() {
  ...
  const onSend = () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        toast.success("¡Gracias! Ganaste la insignia Baddia Stargirl ✨");
        setSent(false);
        setTitle("");
        setDescription("");
        go("profile");
    ...
    <div className="relative min-h-full bg-white pb-16 overflow-hidden">
      ...
      <div className="relative z-10 px-5 mt-5 space-y-5">
        ...
        <p className="text-[11px] text-baddia-ink/45 font-semibold text-center leading-relaxed px-4">
          Al enviar tu primer feedback ganás la insignia <b className="text-baddia-ink/70">✧ Baddia Stargirl</b> en tu perfil.
        </p>
      </div>
